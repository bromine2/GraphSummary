...
//
//		String path = "D:/OpenSourceSystem-Code/RDF-Sum2/" ;
//		//System.out.println(""+sourceDir.getAbsolutePath()+"\n"+storeDir.getAbsolutePath());
//		//copyFiles(sourceDir, storeDir);
//
//		GraphDatabaseService tempGs = new GraphDatabaseFactory().newEmbeddedDatabaseBuilder(path)
